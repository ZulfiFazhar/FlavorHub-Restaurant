  ...
  return (
    <div key={psn.id} className='border border-black rounded-md p-2 mb-3 flex'>
        ...
        <div className='flex flex-col justify-start w-full'>
            ...
            {psn.status == 'diantar' 
                &&
                <button className='border border-black rounded-md w-fit px-2 mt-2 self-end bg-green-600' onClick={() => handleClickUpdateStatus(psn.id, psn.nomor_meja, 'diterima')}>Pesanan diantar</button>
            }
