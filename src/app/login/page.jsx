    ...
    <div className="bg-white h-screen min-h-screen">
      <div className=" flex h-full justify-center items-center w-fit">
        <div className=" h-85p main-gradient ml-12 w-[28rem] rounded-3xl flex flex-col py-10 justify-around items-center text-white">
          ...
          <button
            className="rounded-md px-9 py-1 bg-white text-black"
            onClick={login}
          >
            Login
          </button>
      ...
      <Image
        src={"/decoration/burger2.png"}
        width={200}
        height={200}
        className="absolute top-1 left-96"
        alt="burger2"
      />
      <Image
        src={"/decoration/fries 1.png"}
        width={200}
        height={200}
        className="absolute top-24 left-[40rem]"
        alt="fries1"
      />
      <Image
        src={"/decoration/coffe 1.png"}
        width={200}
        height={200}
        className="absolute top-52 left-[25rem]"
        alt="coffee1"
      />
      <Image
        src={"/decoration/cookies 1.png"}
        width={200}
        height={200}
        className="absolute top-72 left-[38rem]"
        alt="cookies1"
      />
      <Image
        src={"/decoration/pizza 1.png"}
        width={200}
        height={200}
        className="absolute top-96 left-[29rem]"
        alt="pizza1"
      />
    </div>
  );
