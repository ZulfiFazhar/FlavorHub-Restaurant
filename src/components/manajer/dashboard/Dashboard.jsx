...
import {
  hitungTotalPendapatanTahunIni,
  hitungTotalPendapatanBulanIni,
  hitungTotalPelangganTahunIni,
  hitungTotalPelangganBulanIni,
        ...
        <div className="flex items-center shadow-[0_3px_13px_rgba(0,0,0,0.25)] px-3 py-5 rounded-md max-w-56 mr-4">
          <div className="rounded-full bg-slate-100 p-2 mr-3">
            <Icon
              ...
              fontSize={24}
              className="text-green-custom text-lg"
            />
          </div>

          <div className="flex flex-col">
            <p className="text-[0.5rem] mb-[-2px] text-slate-600">
