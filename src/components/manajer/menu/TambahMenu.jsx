  ...
  useEffect(() => {
    if (menu.action == "edit") {
      ...
      if (menu.foto != null) {
        ...
        setPreview((p) => ({
          status: "old-default",
          foto: `/menu/placeholder/menu-foto-placeholder.jpg`,
        }));
      }
    }
  }, [menu]);
  ...
  return (
    <div className="w-1/3 py-5 px-6 flex flex-col bg-slate-200 overflow-x-hidden max-h-screen overflow-y-auto">
      <h1 className="text-3xl">
        {menu.action == "tambah" ? "Tambah Menu" : "Edit Menu"}
      </h1>
      ...
      <div className="mt-1 *:mb-2 mb-8">
        ...
        <div className="mt-6">
          ...
          <input
            ...
            onChange={(event) =>
              setFormTambahMenu((ft) => ({
                ...ft,
                nama_masakan: event.target.value,
              }))
            }
        ...
        <div className="mt-5">
          <label htmlFor="kategori" className="ml-2">
            Kategori
          </label>
          ...
          <div className="flex w-full bg-gray-100 py-2 px-3 rounded-md">
            <div className="flex items-center mr-5">
              <input
                ...
                onClick={(e) =>
                  setFormTambahMenu((ftm) => ({ ...ftm, kategori: "Makanan" }))
                }
              ></input>
              <label htmlFor="Makanan" className="cursor-pointer">
                Makanan
              </label>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                onClick={(e) =>
                  setFormTambahMenu((ftm) => ({ ...ftm, kategori: "Minuman" }))
                }
              ></input>
              <label htmlFor="Minuman" className="cursor-pointer">
                Minuman
              </label>
            </div>
          </div>
        ...
        <div className="mt-5">
          <label htmlFor="deskripsi" className="ml-2">
            Deskripsi
          </label>
          <textarea
            className="bg-white px-3 mt-1 py-2 rounded-lg border-2 border-gray-300 w-full"
        ...
        <div className="mt-5 mb-14">
          <label htmlFor="harga" className="ml-2">
            Harga
          </label>
          <input
            type="number"
            ...
            placeholder="Harga"
            onChange={(event) =>
              setFormTambahMenu((ft) => ({ ...ft, harga: event.target.value }))
            }
