...
function Laporan() {
    ...
    function getFormattedDate({daysBefore=0, monthsBefore=0, yearsBefore=0} = {}){
    ...
    <div className='min-h-screen h-screen max-h-screen px-10 py-10'>
        ...
        <div className='flex items-center mt-7'>
            ...
            <input
                ...
                onChange={() => setRentangWaktu(rw => ({...rw, from:event.target.value}))}
            ...
            <input
                ...
                onChange={() => setRentangWaktu(rw => ({...rw, to:event.target.value}))}
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        {pembayaran?.map((pby, i) => {
                            return (
                                <tr key={pby.id} className={`${i % 2 == 0 ? 'bg-white' : 'bg-slate-100'} border-b`}>
                                    <td scope="row" className="px-3 py-4 font-medium text-gray-900">
                                        {i+1}
                                    </td>
